...
export const getRoomById = async(req:Request<{id:string}>,res:Response<ApiResponse<Rooms | null>>)=>{
...
export const createRoom=async(req:Request<{},{},CreateRoomsBody>,res:Response<ApiResponse<Rooms | null>>)=>{
...
export const updateRoom =  async(req:Request<{id:string}>,res:Response<ApiResponse<Rooms | null>>)=>{
  const id = Number(req.params.id);
  const {room_number,type,price,is_available} = req.body;
...
export const deleteRoom = async(req:Request<{id:string}>,res:Response<ApiResponse<Rooms | null>>)=>{
  const id = Number(req.params.id);
