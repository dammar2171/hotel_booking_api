...
exports.getBookingByGuestId = exports.updateBookingSchema = exports.createBookingSchema = exports.getBookingById = exports.getBookings = void 0;
...
const createBookingSchema = async (req, res) => {
...
const updateBookingSchema = async (req, res) => {
    const id = Number(req.params.id);
